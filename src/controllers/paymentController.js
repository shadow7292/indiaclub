...
const initiateWowPayPayment = async (req, res) => {
    ...
    try {
        ...
        const params = {
            ...
            // notify_url: `https://bbdwin.online/wallet/verify/wowpay`,
            mch_return_msg: user.phone,
            // payment_key: 'd80b014fab7e487bb1dd765e79fbf862',
        };

        // params.page_url = 'https:///bbdwin.online/verify/wowpay';

        params.sign = wowpay.generateSign(params, process.env.WOWPAY_MERCHANT_KEY);
        // params.sign = wowpay.generateSign(params, 'd80b014fab7e487bb1dd765e79fbf862');
        // params.sign = wowpay.generateSign(params, 'd80b014fab7e487bb1dd765e79fbf862');
